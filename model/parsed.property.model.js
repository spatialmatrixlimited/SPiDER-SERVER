...
var ParsedPropertySchema = mongoose.Schema;
var parsedPropertySchema = new ParsedPropertySchema({
	property: {
		property_id: String,
		street_id: String,
...
module.exports = mongoose.model('ParsedProperty', parsedPropertySchema, 'friday_parsed_properties');